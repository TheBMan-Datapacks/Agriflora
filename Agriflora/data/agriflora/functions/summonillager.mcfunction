...
execute at @e[type=enderman,tag=!IsHere] if block ~ ~-1 ~ end_stone if score SpawnEnder IsMobSpawn = HighEnder IsMobSpawn unless entity @e[type=ender_dragon] run summon minecraft:illusioner ~ ~ ~
